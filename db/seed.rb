class Seeder
	...
	def self.attachments!
		Attachment.create(uuid: SecureRandom.uuid, file: "/123/sdjfb.png", issue_id: 1, user_id: 2)
		Attachment.create(uuid: SecureRandom.uuid, file: "/456/sdjfb.png", issue_id: 2, user_id: 2)
		Attachment.create(uuid: SecureRandom.uuid, file: "/789/sdjfb.png", issue_id: 3, user_id: 2)
	end
